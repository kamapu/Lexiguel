#' @name rc_gaps-data
#'
#' @aliases rc_gaps rc_gaps.env rc_gaps.env-data
#'
#' @docType data
#'
#' @title Plant Diversity in Forest Gaps on the Robinson Crusoe Island
#'
#' @description
...
#' The vegetation table (`rc_gaps`) is formatted as a presence/absence matrix
#' with the gaps (units) as rows and the species as columns.
#' The data frame `rc_gaps.env` contains information about the surface size of
